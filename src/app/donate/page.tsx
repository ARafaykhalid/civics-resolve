    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 animate-fade-in">
      <div className="mb-8">
        ...
        <p className="mt-2 text-slate-400">
          Donate to community campaigns. Scan the QR code, pay, and submit your
          transaction proof.
        </p>
      </div>
              ...
              <Link
                ...
                <div className="glass-card overflow-hidden transition-all duration-300 hover:border-indigo-500/30 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/10">
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="mt-3 text-lg font-semibold text-white line-clamp-2 group-hover:text-indigo-400 transition-colors">
                      {c.title}
                    </h3>
                    ...
                    <div className="mt-4 space-y-2">
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className="text-slate-500">
                          ₹{c.goalAmount.toLocaleString()} goal
                        </span>
                      </div>
