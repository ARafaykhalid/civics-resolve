...
export default function SubmitPage() {
  ...
  return (
    <div
      ref={container}
      className="min-h-[calc(100vh-4rem)] flex relative overflow-hidden bg-slate-950">
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row relative z-10">
        ...
        <div className="split-left lg:w-5/12 p-8 lg:p-16 flex flex-col justify-center">
          ...
          <p className="text-lg text-slate-400 mb-12">
            Your voice matters. By reporting civic issues, you initiate the
            first step towards a better, safer, and cleaner community.
            Authorities and volunteers are standing by.
          </p>
            ...
            {[
              {
                ...
                desc: "Clear photos help authorities understand the severity of the issue immediately.",
              },
              {
                icon: Map,
                title: "Pinpoint Location",
                desc: "Accurate addresses and coordinates ensure quick dispatch of repair teams.",
              },
              {
                icon: HelpCircle,
                title: "Be Descriptive",
                desc: "The more details you provide, the faster we can verify and resolve the problem.",
              },
            ].map((item, i) => (
        ...
        <div className="split-right lg:w-7/12 p-4 lg:p-12 flex items-center justify-center">
          <div className="w-full max-w-2xl glass-card p-6 sm:p-10 rounded-3xl shadow-2xl border-white/10 relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              {error && (
                <div className="form-element flex items-center gap-2 rounded-xl bg-red-500/10 border border-red-500/20 p-4 text-sm text-red-400 font-medium">
              ...
              <div className="form-element">
                ...
                <input
                  ...
                  className="input-field bg-slate-950/50"
              ...
              <div className="form-element relative z-50">
              ...
              <div className="form-element">
                ...
                <textarea
                  ...
                  className="input-field bg-slate-950/50 min-h-[120px] resize-y"
                  placeholder="Describe the issue in detail. What is it? When did you notice it?"
                  required
                  minLength={20}
                  maxLength={2000}
                />
                <p className="mt-1.5 text-xs text-slate-500 font-medium flex justify-end">
                ...
                <div className="mt-3 grid grid-cols-2 gap-3">
                  <div>
                    <input
                      ...
                      className="input-field bg-slate-950/50 text-sm py-2"
                ...
                <label className="flex items-start gap-3 rounded-xl bg-slate-900/50 p-4 cursor-pointer border border-white/5 hover:border-white/10 transition-colors group">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">
                      ...
                      timeline, though authorities can still follow up
                      internally.
                    </p>
                  </div>
                </label>
              ...
              <div className="form-element pt-4">
                <button
                  type="submit"
                  disabled={loading}
                  className="btn-primary w-full py-4 text-lg font-bold shadow-indigo-500/30">
                  {loading ? (
      ...
      <AuthModal
        ...
        message="You need to sign in to submit a report and track its progress."
      />
    </div>
  );
}
